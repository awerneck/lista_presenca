...
from google_api import registrar_presenca, get_presencas
from qr_token.py import validar_token, gerar_token, token_atual
...
def presenca():
    if request.method == "POST":
        ...
        if not validar_token(token):
            return "Token expirado! Atualize o QR Code."
